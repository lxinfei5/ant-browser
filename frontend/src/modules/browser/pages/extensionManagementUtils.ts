...
export const EXTENSION_HISTORY_STORAGE_KEY = 'profilepool.extensionManagement.history.v1'
export const EXTENSION_DOWNLOAD_PROXY_STORAGE_KEY = 'profilepool.extensionManagement.downloadProxy.v1'
